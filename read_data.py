...
testing_file = '/gpfs/fs0/scratch/j/jphickey/g2malik/working_code/Q2_Detection/test.dat' # temporary file for debugging
...
for time in range (start_t,37):
    ...
    model = kde_plus_Q2(XY,UU,VV,WW,uhis,z_plane,binbin,x_plane+1,time_stamp,testing_file, delta_points, btfti, TT)
    ...
    print(len(u_event_profile[time]))
